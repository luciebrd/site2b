...
//Defaults
var settings = { 
  width: 900,     // Default width; height is determined by projection
  ...
  lang: "fr",           // Global language override for names, any name setting that has the chosen language available
  ...
  planets: {  //Show planet locations, if date-time is set
    ...
    symbolType: "disk",  // Type of planetary symbol to be displayed: 'symbol', 'letter' or 'disk'
    names: true,  // Show name next to symbol
    ...
    namesType: "fr"  // Language in which the name is displayed, options desig, ar, cn, en, fr, de, gr, il, in, it, jp, lat, ru, es
  },
